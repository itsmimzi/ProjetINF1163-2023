...
public class Projet {
    ...
    *********************************************************************************************************/
    ...
    public void ajusterHeureBudgetParDiscipline(String discipline,double montant){
        if(heuresBudgetParDiscipline.containsKey(discipline)){
            ...
            heuresBudgetParDiscipline.put(discipline, montant);
        }
   ...
   public double getHeureBudgetParDiscipline(String discipline){
        if(heuresBudgetParDiscipline.get(Discipline.valueOf(discipline)) == null){
            return 0;
        }
        return heuresBudgetParDiscipline.get(Discipline.valueOf(discipline));
   }
