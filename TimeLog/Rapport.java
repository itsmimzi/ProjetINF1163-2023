 ...
 * */
 ...
 /**************************************** Ajout déduction ***********************************************
   *********************************************************************************************************/
    ...
    /**
     * Ajoute une déduction pour un employé donné.
     *
     * @param idEmploye L'identifiant de l'employé.
     * @param deduction Le montant de la déduction.
     */
   public void ajouterDeduction(int idEmploye, double deduction) {
    if (deductions.containsKey(idEmploye)) {
        // Si l'employé a déjà des déductions, ajouter la nouvelle déduction à la valeur existante
        double montantTotalDeductions = deductions.get(idEmploye) + deduction;
        deductions.put(idEmploye, montantTotalDeductions);
    } else {
